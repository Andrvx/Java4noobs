...
public class Main {
    public static void main(String[] args) {
        ...
        SP.crearPersona(persona1);

        System.out.println("*** Calculando Edad ***");
        System.out.println("Edad: "+SP.calcularEdad(persona1));

        SP.mostrarPersona(persona1);

        System.out.println("Decime tu edad, aver si sos menor o mayor que la persona");
        int edadNueva= leer.nextInt();

        if (SP.menorQue(edadNueva,persona1)){
